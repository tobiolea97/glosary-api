...
insert into examples(expression_id, sentence)
    values (1, 'We are about to {1} of milk. Could you bring some from the store?');
insert into gaps(example_id, order_number, alternative_answer_1, wrong_answer_1, wrong_answer_2, wrong_answer_3)
    values (1, 1, 'run out', 'run down', 'set out', 'run off');

-- Phrasal verb: "Look forward to"
insert into expressions(title, card_example, definition, topic_type_id)
    values ('Look forward to', 'She *looks forward to* her vacation every year', 'To be excited and pleased about something that is going to happen', 1);
insert into examples(expression_id, sentence)
    values (2, 'We {1} seeing you at the party next week.');
insert into gaps(example_id, order_number, alternative_answer_1, wrong_answer_1, wrong_answer_2, wrong_answer_3)
    values (2, 1, 'look forward to', 'look into', 'look for', 'look forward for');

-- Phrasal verb: "Bring up"
insert into expressions(title, card_example, definition, topic_type_id)
    values ('Bring up', 'She *brought up* an interesting point during the meeting', 'To mention a subject or start to talk about it', 1);
insert into examples(expression_id, sentence)
    values (3, "I didn't want to {1} the topic during dinner.");
insert into gaps(example_id, order_number, alternative_answer_1, wrong_answer_1, wrong_answer_2, wrong_answer_3)
    values (3, 1, 'bring up', 'bring in', 'bring out', 'bring over');

-- Phrasal verb: "Take off"
insert into expressions(title, card_example, definition, topic_type_id)
    values ('Take off', 'The plane *took off* right on schedule', 'When an aircraft leaves the ground and begins to fly', 1);
insert into examples(expression_id, sentence)
    values (4, 'The rocket {1} with a deafening roar.');
insert into gaps(example_id, order_number, alternative_answer_1, wrong_answer_1, wrong_answer_2, wrong_answer_3)
    values (4, 1, 'took off', 'took out', 'took away', 'took in');
...
insert into expressions(title, card_example, definition, topic_type_id)
    values ("A piece of cake", "The exam was *a piece of cake* for him because he had studied so much", "Something that is very easy to do", 5);
insert into examples(expression_id, sentence)
    values (20, "The test was {1} because she had studied so much.");
insert into gaps(example_id, order_number, alternative_answer_1, wrong_answer_1, wrong_answer_2, wrong_answer_3)
    values (20, 1, "a piece of cake", "piece of cake", "cake piece", "cake of piece");
